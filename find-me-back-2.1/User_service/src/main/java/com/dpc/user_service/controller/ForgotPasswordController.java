...
import com.dpc.user_service.Entities.PasswordForgot;
import com.dpc.user_service.Entities.PasswordResetToken;
import com.dpc.user_service.Entities.User;
import com.dpc.user_service.services.EmailService;
import com.dpc.user_service.services.PasswordResetTokenService;
...
public class ForgotPasswordController {
    ...
    public ResponseEntity<String> processPasswordForgot(@RequestBody PasswordForgot passwordForgot, BindingResult result) {
        ...
        String url = "https://dev.find-me-2.1.dpc.com.tn/reinitialiser-mot-passe?token=" + token.getToken();
